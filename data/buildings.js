...
const BUILDINGS = {
  ...
  // ===== 平原 =====
  // category 只有平原用來細分「種植 / 畜牧 / 加工 / 烹飪 / 商店」五個子系統，方便畫面分組顯示
  ...
  mill:          { id: 'mill',          name: '磨坊',     spot: 'plains', type: 'processing', icon: '🌀', unlockLevel: 2, cost: { wood: 25, stone_f: 15 }, category: 'processing' },
  tailor_shop:   { id: 'tailor_shop',   name: '裁縫坊',   spot: 'plains', type: 'processing', icon: '🧵', unlockLevel: 3, cost: { wood: 30, leather: 5 }, category: 'processing' },
